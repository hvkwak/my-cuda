...
int main(int argc, char **argv)
{
    ...
    printf("device %d: %s memory size %d nbyte %5.2fMB canMap %d ", dev,
           deviceProp.name, isize, nbytes / (1024.0f * 1024.0f),
           deviceProp.canMapHostMemory); // TODO: check what this MapHostMemory is
    ...
    printf("gpu pinMemTransfer elapsed %f sec, Alloc. %f sec, Dealloc. %f sec\n", Elaps, Allocate, Deallocate);
